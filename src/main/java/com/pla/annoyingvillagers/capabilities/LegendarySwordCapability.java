...
public class LegendarySwordCapability {
    ...
    public static final Function<Item, Builder> LEGENDARYSWORD = (item) -> {
        ...
        }).collider(ColliderPreset.GREATSWORD).swingSound(EpicFightSounds.WHOOSH_BIG).hitSound(EpicFightSounds.BLADE_HIT).canBePlacedOffhand(false).newStyleCombo(Styles.TWO_HAND, new StaticAnimation[]{WOMAnimations.TORMENT_AUTO_1, WOMAnimations.TORMENT_AUTO_2, WOMAnimations.SOLAR_AUTO_1, WOMAnimations.SOLAR_AUTO_2, WOMAnimations.SOLAR_AUTO_2_POLVORA, WOMAnimations.SOLAR_AUTO_3, WOMAnimations.SOLAR_AUTO_4, WOMAnimations.TORMENT_AUTO_4, WOMAnimations.TORMENT_CHARGED_ATTACK_2, EFAnimations.GREATSWORD_DUAL_AUTO_3, WOMAnimations.TORMENT_CHARGED_ATTACK_1, WOMAnimations.TORMENT_DASH, WOMAnimations.TORMENT_AIRSLAM}).newStyleCombo(Styles.MOUNT, new StaticAnimation[]{Animations.SWORD_MOUNT_ATTACK}).innateSkill(Styles.TWO_HAND, (itemstack) -> {
    ...
    public static final Function<Item, Builder> AXE = (item) -> {
        return WeaponCapability.builder().category(WeaponCategories.AXE).styleProvider((livingentitypatch) -> {
            return livingentitypatch.getHoldingItemCapability(InteractionHand.OFF_HAND).getWeaponCategory() != WeaponCategories.AXE && livingentitypatch.getHoldingItemCapability(InteractionHand.OFF_HAND).getWeaponCategory() != WeaponCategories.SWORD && livingentitypatch.getHoldingItemCapability(InteractionHand.OFF_HAND).getWeaponCategory() != WeaponCategories.TACHI ? Styles.TWO_HAND : Styles.OCHS;
        }).collider(EFColliders.GREATSWORD).swingSound(EpicFightSounds.WHOOSH_BIG).hitSound(EpicFightSounds.BLADE_HIT).newStyleCombo(Styles.TWO_HAND, new StaticAnimation[]{Animations.AXE_AUTO1, Animations.AXE_AUTO2, Animations.AXE_DASH, Animations.AXE_AIRSLASH}).innateSkill(Styles.TWO_HAND, (itemstack) -> {
            return EpicFightSkills.GUILLOTINE_AXE;
        }).livingMotionModifier(Styles.TWO_HAND, LivingMotions.IDLE, Animations.BIPED_IDLE).livingMotionModifier(Styles.TWO_HAND, LivingMotions.WALK, Animations.BIPED_WALK).livingMotionModifier(Styles.TWO_HAND, LivingMotions.CHASE, Animations.BIPED_WALK).livingMotionModifier(Styles.TWO_HAND, LivingMotions.RUN, AVAnimations.RUN_HOLD).livingMotionModifier(Styles.TWO_HAND, LivingMotions.JUMP, Animations.BIPED_JUMP).livingMotionModifier(Styles.TWO_HAND, LivingMotions.KNEEL, Animations.BIPED_KNEEL).livingMotionModifier(Styles.TWO_HAND, LivingMotions.SNEAK, Animations.BIPED_SNEAK).livingMotionModifier(Styles.TWO_HAND, LivingMotions.SWIM, Animations.BIPED_SWIM).livingMotionModifier(Styles.TWO_HAND, LivingMotions.BLOCK, Animations.SWORD_GUARD).newStyleCombo(Styles.OCHS, new StaticAnimation[]{AVAnimations.AXE_DUAL_AUTO_1, AVAnimations.AXE_DUAL_AUTO_2, AVAnimations.AXE_DUAL_AUTO_3, EFAnimations.GREATSWORD_DUAL_AUTO_3, EFAnimations.GREATSWORD_DUAL_AUTO_4, AVAnimations.DUAL_SWORD_AUTO4, Animations.SWORD_DUAL_DASH, Animations.VINDICATOR_SWING_AXE3}).innateSkill(Styles.OCHS, (itemstack) -> {
            return EFSkills.EARTHQUAKE;
        }).livingMotionModifier(Styles.OCHS, LivingMotions.WALK, Animations.BIPED_WALK).livingMotionModifier(Styles.OCHS, LivingMotions.CHASE, Animations.BIPED_WALK).livingMotionModifier(Styles.OCHS, LivingMotions.RUN, Animations.BIPED_RUN_DUAL).livingMotionModifier(Styles.OCHS, LivingMotions.JUMP, EFAnimations.GREATSWORD_DUAL_RUN).livingMotionModifier(Styles.OCHS, LivingMotions.KNEEL, Animations.BIPED_HOLD_GREATSWORD).livingMotionModifier(Styles.OCHS, LivingMotions.SNEAK, Animations.BIPED_HOLD_GREATSWORD).livingMotionModifier(Styles.OCHS, LivingMotions.SWIM, Animations.BIPED_HOLD_GREATSWORD).livingMotionModifier(Styles.OCHS, LivingMotions.BLOCK, Animations.SWORD_DUAL_GUARD).weaponCombinationPredicator((livingentitypatch) -> {
    ...
    public static final Function<Item, Builder> SWORD = (item) -> {
        yesman.epicfight.world.capabilities.item.WeaponCapability.Builder yesman_epicfight_world_capabilities_item_weaponcapability_builder = WeaponCapability.builder().category(WeaponCategories.SWORD).swingSound(AVSounds.SWORD_WHOOSH).styleProvider((livingentitypatch) -> {
        ...
        if (item instanceof TieredItem) {
            ...
            yesman_epicfight_world_capabilities_item_weaponcapability_builder.hitSound(tiereditem.getTier() == Tiers.WOOD ? EpicFightSounds.BLUNT_HIT : EpicFightSounds.BLADE_HIT);
    ...
    public static final Function<Item, Builder> TACHI = (item) -> {
        ...
        }).collider(ColliderPreset.TACHI).hitSound(EpicFightSounds.BLADE_HIT).swingSound(AVSounds.SWORD_WHOOSH).styleProvider((livingentitypatch) -> {
        ...
        }).newStyleCombo(Styles.TWO_HAND, new StaticAnimation[]{Animations.TACHI_AUTO1, Animations.TACHI_AUTO2, Animations.TACHI_AUTO3, AVAnimations.TACHI_DASH, Animations.LONGSWORD_AIR_SLASH}).newStyleCombo(Styles.OCHS, new StaticAnimation[]{AVAnimations.AXE_DUAL_AUTO_1, AVAnimations.AXE_DUAL_AUTO_2, AVAnimations.DUAL_SWORD_AUTO3, EFAnimations.GREATSWORD_DUAL_AUTO_4, AVAnimations.DUAL_SWORD_AUTO5, AVAnimations.DUAL_SWORD_AUTO4, Animations.SWORD_DUAL_DASH, Animations.SWORD_DUAL_AIR_SLASH}).newStyleCombo(Styles.MOUNT, new StaticAnimation[]{Animations.SWORD_MOUNT_ATTACK}).innateSkill(Styles.TWO_HAND, (itemstack) -> {
...
//    public static final Function<Item, Builder> DUALPISTOL = (item) -> {
//        return WeaponCapability.builder().category(AVCategories.DUALPISTOL).styleProvider((livingentitypatch) -> {
//            return livingentitypatch.getHoldingItemCapability(InteractionHand.OFF_HAND).getWeaponCategory() == AVCategories.DUALPISTOL ? Styles.OCHS : Styles.TWO_HAND;
//        }).canBePlacedOffhand(true).livingMotionModifier(Styles.TWO_HAND, LivingMotions.IDLE, AVAnimations.BIPED_HOLD_PISTOL).livingMotionModifier(Styles.TWO_HAND, LivingMotions.KNEEL, AVAnimations.BIPED_HOLD_PISTOL).livingMotionModifier(Styles.TWO_HAND, LivingMotions.WALK, AVAnimations.BIPED_WALK_PISTOL).livingMotionModifier(Styles.TWO_HAND, LivingMotions.CHASE, AVAnimations.BIPED_WALK_PISTOL).livingMotionModifier(Styles.TWO_HAND, LivingMotions.RUN, AVAnimations.BIPED_RUN_PISTOL).livingMotionModifier(Styles.TWO_HAND, LivingMotions.SNEAK, AVAnimations.BIPED_HOLD_PISTOL).livingMotionModifier(Styles.TWO_HAND, LivingMotions.SWIM, AVAnimations.BIPED_HOLD_PISTOL).livingMotionModifier(Styles.TWO_HAND, LivingMotions.FLOAT, AVAnimations.BIPED_HOLD_PISTOL).livingMotionModifier(Styles.TWO_HAND, LivingMotions.FALL, AVAnimations.BIPED_HOLD_PISTOL).livingMotionModifier(Styles.OCHS, LivingMotions.IDLE, AVAnimations.BIPED_HOLD_DUAL_PISTOL).livingMotionModifier(Styles.OCHS, LivingMotions.KNEEL, AVAnimations.BIPED_HOLD_DUAL_PISTOL).livingMotionModifier(Styles.OCHS, LivingMotions.WALK, AVAnimations.BIPED_WALK_DUAL_PISTOL).livingMotionModifier(Styles.OCHS, LivingMotions.CHASE, AVAnimations.BIPED_WALK_DUAL_PISTOL).livingMotionModifier(Styles.OCHS, LivingMotions.RUN, AVAnimations.BIPED_RUN_DUAL_PISTOL).livingMotionModifier(Styles.OCHS, LivingMotions.SNEAK, AVAnimations.BIPED_HOLD_DUAL_PISTOL).livingMotionModifier(Styles.OCHS, LivingMotions.SWIM, AVAnimations.BIPED_HOLD_DUAL_PISTOL).livingMotionModifier(Styles.OCHS, LivingMotions.FLOAT, AVAnimations.BIPED_HOLD_DUAL_PISTOL).livingMotionModifier(Styles.OCHS, LivingMotions.FALL, AVAnimations.BIPED_HOLD_DUAL_PISTOL).weaponCombinationPredicator((livingentitypatch) -> {
//            return livingentitypatch.getHoldingItemCapability(InteractionHand.OFF_HAND).getWeaponCategory() == WeaponCategories.AXE ? true : (livingentitypatch.getHoldingItemCapability(InteractionHand.OFF_HAND).getWeaponCategory() == WeaponCategories.SWORD ? true : (livingentitypatch.getHoldingItemCapability(InteractionHand.OFF_HAND).getWeaponCategory() == AVCategories.DUALPISTOL ? true : false));
//        });
//    };
    ...
    public static final Function<Item, Builder> HGSD = (item) -> {
        yesman.epicfight.world.capabilities.item.WeaponCapability.Builder yesman_epicfight_world_capabilities_item_weaponcapability_builder = WeaponCapability.builder().category(WeaponCategories.GREATSWORD).styleProvider((livingentitypatch) -> {
            return Styles.TWO_HAND;
        }).collider(ColliderPreset.GREATSWORD).swingSound(EpicFightSounds.WHOOSH_BIG).hitSound(EpicFightSounds.BLADE_HIT).canBePlacedOffhand(false).newStyleCombo(Styles.TWO_HAND, new StaticAnimation[]{WOMAnimations.TORMENT_AUTO_1, WOMAnimations.TORMENT_AUTO_2, WOMAnimations.TORMENT_AUTO_3, WOMAnimations.TORMENT_AUTO_4, WOMAnimations.TORMENT_DASH, WOMAnimations.TORMENT_AIRSLAM}).newStyleCombo(Styles.MOUNT, new StaticAnimation[]{Animations.SWORD_MOUNT_ATTACK}).innateSkill(Styles.TWO_HAND, (itemstack) -> {
            return EpicFightSkills.STEEL_WHIRLWIND;
        }).livingMotionModifier(Styles.TWO_HAND, LivingMotions.IDLE, WOMAnimations.SOLAR_IDLE).livingMotionModifier(Styles.TWO_HAND, LivingMotions.WALK, WOMAnimations.SOLAR_WALK).livingMotionModifier(Styles.TWO_HAND, LivingMotions.CHASE, WOMAnimations.SOLAR_RUN).livingMotionModifier(Styles.TWO_HAND, LivingMotions.RUN, WOMAnimations.SOLAR_RUN).livingMotionModifier(Styles.TWO_HAND, LivingMotions.SWIM, Animations.BIPED_HOLD_GREATSWORD).livingMotionModifier(Styles.TWO_HAND, LivingMotions.BLOCK, Animations.GREATSWORD_GUARD).weaponCombinationPredicator((livingentitypatch) -> {
            return livingentitypatch.getHoldingItemCapability(InteractionHand.OFF_HAND).getWeaponCategory() == WeaponCategories.AXE ? true : (livingentitypatch.getHoldingItemCapability(InteractionHand.OFF_HAND).getWeaponCategory() == WeaponCategories.SWORD ? true : (livingentitypatch.getHoldingItemCapability(InteractionHand.OFF_HAND).getWeaponCategory() == WeaponCategories.DAGGER ? true : false));
        });
    ...
    public static final Function<Item, Builder> REDGREATSWORD = (item) -> {
        yesman.epicfight.world.capabilities.item.WeaponCapability.Builder yesman_epicfight_world_capabilities_item_weaponcapability_builder = WeaponCapability.builder().category(WeaponCategories.GREATSWORD).styleProvider((livingentitypatch) -> {
            return Styles.TWO_HAND;
        }).collider(ColliderPreset.GREATSWORD).swingSound(EpicFightSounds.WHOOSH_BIG).hitSound(EpicFightSounds.BLADE_HIT).canBePlacedOffhand(false).newStyleCombo(Styles.TWO_HAND, new StaticAnimation[]{Animations.GREATSWORD_AUTO1, Animations.GREATSWORD_AUTO2, WOMAnimations.SOLAR_AUTO_3_POLVORA, WOMAnimations.TORMENT_AUTO_3, WOMAnimations.TORMENT_AUTO_4, WOMAnimations.SOLAR_AUTO_4_POLVORA, WOMAnimations.TORMENT_DASH, WOMAnimations.TORMENT_AIRSLAM}).newStyleCombo(Styles.MOUNT, new StaticAnimation[]{Animations.SWORD_MOUNT_ATTACK}).innateSkill(Styles.TWO_HAND, (itemstack) -> {
            return EpicFightSkills.STEEL_WHIRLWIND;
...
//        weaponcapabilitypresetregistryevent.getTypeEntry().put("dualpistol", LegendarySwordCapability.DUALPISTOL);
