...
public class LoginMusicButtonMessage {
    ...
    public static void registerMessage(FMLCommonSetupEvent fmlcommonsetupevent) {
        AnnoyingVillagersMod.addNetworkMessage(LoginMusicButtonMessage.class, LoginMusicButtonMessage::buffer, LoginMusicButtonMessage::new, LoginMusicButtonMessage::handler);
    }
