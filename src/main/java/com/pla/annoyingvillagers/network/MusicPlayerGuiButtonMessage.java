...
public class MusicPlayerGuiButtonMessage {
    ...
    public static void registerMessage(FMLCommonSetupEvent fmlcommonsetupevent) {
        AnnoyingVillagersMod.addNetworkMessage(MusicPlayerGuiButtonMessage.class, MusicPlayerGuiButtonMessage::buffer, MusicPlayerGuiButtonMessage::new, MusicPlayerGuiButtonMessage::handler);
    }
