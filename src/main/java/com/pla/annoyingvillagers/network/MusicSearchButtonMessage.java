...
public class MusicSearchButtonMessage {
    ...
    public static void registerMessage(FMLCommonSetupEvent fmlcommonsetupevent) {
        AnnoyingVillagersMod.addNetworkMessage(MusicSearchButtonMessage.class, MusicSearchButtonMessage::buffer, MusicSearchButtonMessage::new, MusicSearchButtonMessage::handler);
    }
