...
public class BlueVillagerGeneralHelmetFixItem extends Item {
    public BlueVillagerGeneralHelmetFixItem() {
    ...
    public void inventoryTick(ItemStack stack, Level level, Entity entity, int slotId, boolean flag) {
        ...
        ItemStack replacement = randomDamage(new ItemStack(AnnoyingVillagersModItems.BLUE_VILLAGER_GENERAL_HELMET.get()));
