...
public class PurpleVillagerGeneralHelmetFixItem extends Item {
    public PurpleVillagerGeneralHelmetFixItem() {
    ...
    public void inventoryTick(ItemStack stack, Level level, Entity entity, int slotId, boolean flag) {
        ...
        ItemStack replacement = randomDamage(new ItemStack(AnnoyingVillagersModItems.GREEN_VILLAGER_GENERAL_HELMET.get()));
