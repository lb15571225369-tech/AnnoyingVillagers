...
public class RenderLegendarySword extends RenderItemBase {
    ...
    public void renderItemInHand(ItemStack stack,
        ...
        if (livingEntityPatch != null) {
            ...
            if (dynamicAnimation ==  AVAnimations.LEGENDARY_SWORD_WAKE_UP_ATTACK || dynamicAnimation == AVAnimations.LEGENDARY_SWORD_HEAVY_ATTACK || dynamicAnimation == AnimsSolar.SOLAR_AUTO_2
                    || dynamicAnimation == AnimsNapoleon.NAPOLEON_AUTO_3 || dynamicAnimation == AnimsNapoleon.NAPOLEON_AUSTERLITZ_SHOOT
                    || dynamicAnimation == AnimsNapoleon.NAPOLEON_AUTO_4 || dynamicAnimation == AnimsNapoleon.NAPOLEON_WATERLOW_SHOOT) {
