...
public class DianhuParticle extends TextureSheetParticle {
    ...
    public static DianhuParticle.DianhuParticleProvider provider(SpriteSet spriteset) {
        return new DianhuParticle.DianhuParticleProvider(spriteset);
    }

    protected DianhuParticle(ClientLevel clientlevel, double d0, double d1, double d2, double d3, double d4, double d5, SpriteSet spriteset) {
    ...
    public static class DianhuParticleProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleparticletype, ClientLevel clientlevel, double d0, double d1, double d2, double d3, double d4, double d5) {
            return new DianhuParticle(clientlevel, d0, d1, d2, d3, d4, d5, this.spriteSet);
        }
    }
}
