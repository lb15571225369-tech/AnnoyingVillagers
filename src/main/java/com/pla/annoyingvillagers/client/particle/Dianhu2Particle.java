...
public class Dianhu2Particle extends TextureSheetParticle {
    ...
    public static Dianhu2Particle.Dianhu2ParticleProvider provider(SpriteSet spriteset) {
        return new Dianhu2Particle.Dianhu2ParticleProvider(spriteset);
    }

    protected Dianhu2Particle(ClientLevel clientlevel, double d0, double d1, double d2, double d3, double d4, double d5, SpriteSet spriteset) {
    ...
    public static class Dianhu2ParticleProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleparticletype, ClientLevel clientlevel, double d0, double d1, double d2, double d3, double d4, double d5) {
            return new Dianhu2Particle(clientlevel, d0, d1, d2, d3, d4, d5, this.spriteSet);
        }
    }
}
