...
public class MusicPlayerGuiScreen extends AbstractContainerScreen<MusicPlayerGuiMenu> {
    ...
    private static final ResourceLocation texture = new ResourceLocation("annoying_villagers:textures/screens/music_player_gui.png");
    ...
    protected void renderLabels(PoseStack posestack, int i, int j) {
        this.font.draw(posestack, new TranslatableComponent("gui.annoying_villagers.music_player_gui.label_qing_shu_ru_yin_le_id"), 28.0F, 28.0F, -12829636);
    }
    ...
    public void init() {
        ...
        MusicPlayerGuiScreen.music_id = new EditBox(this.font, this.leftPos + 28, this.topPos + 40, 120, 20, new TranslatableComponent("gui.annoying_villagers.music_player_gui.music_id"));
        ...
        this.button_empty = new Button(this.leftPos + 63, this.topPos + 80, 46, 20, new TranslatableComponent("gui.annoying_villagers.music_player_gui.button_empty"), (button) -> {
            MusicPlayerGuiScreen.textstate.put("textin:music_id", MusicPlayerGuiScreen.music_id.getValue());
            AnnoyingVillagersMod.PACKET_HANDLER.sendToServer(new MusicPlayerGuiButtonMessage(0, this.x, this.y, this.z, MusicPlayerGuiScreen.textstate));
        ...
        this.button_login = new Button(this.leftPos + 44, this.topPos + 126, 84, 20, new TranslatableComponent("gui.annoying_villagers.music_player_gui.button_login"), (button) -> {
            MusicPlayerGuiScreen.textstate.put("textin:music_id", MusicPlayerGuiScreen.music_id.getValue());
            AnnoyingVillagersMod.PACKET_HANDLER.sendToServer(new MusicPlayerGuiButtonMessage(1, this.x, this.y, this.z, MusicPlayerGuiScreen.textstate));
        ...
        this.button_music_list = new Button(this.leftPos + 91, this.topPos + 5, 77, 20, new TranslatableComponent("gui.annoying_villagers.music_player_gui.button_music_list"), (button) -> {
        });
        ...
        this.button_vote = new Button(this.leftPos + 8, this.topPos + 126, 29, 20, new TranslatableComponent("gui.annoying_villagers.music_player_gui.button_vote"), (button) -> {
            MusicPlayerGuiScreen.textstate.put("textin:music_id", MusicPlayerGuiScreen.music_id.getValue());
            AnnoyingVillagersMod.PACKET_HANDLER.sendToServer(new MusicPlayerGuiButtonMessage(3, this.x, this.y, this.z, MusicPlayerGuiScreen.textstate));
        ...
        this.button_search = new Button(this.leftPos + 6, this.topPos + 5, 76, 20, new TranslatableComponent("gui.annoying_villagers.music_player_gui.button_search"), (button) -> {
            MusicPlayerGuiScreen.textstate.put("textin:music_id", MusicPlayerGuiScreen.music_id.getValue());
            AnnoyingVillagersMod.PACKET_HANDLER.sendToServer(new MusicPlayerGuiButtonMessage(4, this.x, this.y, this.z, MusicPlayerGuiScreen.textstate));
