...
public class LoginMusicScreen extends AbstractContainerScreen<LoginMusicMenu> {
    ...
    Button button_yes;
    private static final ResourceLocation texture = new ResourceLocation("annoying_villagers:textures/screens/login_music.png");
    ...
    protected void renderLabels(PoseStack posestack, int i, int j) {
        this.font.draw(posestack, new TranslatableComponent("gui.annoying_villagers.login_music.label_phoneid"), 27.0F, 31.0F, -12829636);
    }
    ...
    public void init() {
        ...
        LoginMusicScreen.code = new EditBox(this.font, this.leftPos + 28, this.topPos + 45, 120, 20, new TranslatableComponent("gui.annoying_villagers.login_music.code"));
        ...
        this.button_yes = new Button(this.leftPos + 55, this.topPos + 82, 65, 20, new TranslatableComponent("gui.annoying_villagers.login_music.button_yes"), (button) -> {
            LoginMusicScreen.textstate.put("textin:code", LoginMusicScreen.code.getValue());
            AnnoyingVillagersMod.PACKET_HANDLER.sendToServer(new LoginMusicButtonMessage(0, this.x, this.y, this.z, LoginMusicScreen.textstate));
