...
//    Button button_login;
//    Button button_x;
//    private static final ResourceLocation texture = new ResourceLocation(AnnoyingVillagers.MODID + ":textures/screens/id_check.png");
//
...
//        this.font.draw(posestack, new TranslatableComponent("gui.annoyingvillagers.id_check.label_id"), 28.0F, 28.0F, -12829636);
//    }
//
//    public void onClose() {
//        super.onClose();
...
//        IdCheckScreen.id_check = new EditBox(this.font, this.leftPos + 28, this.topPos + 45, 120, 20, new TranslatableComponent("gui.annoyingvillagers.id_check.id_check"));
...
//        this.button_login = new Button(this.leftPos + 62, this.topPos + 94, 51, 20, new TranslatableComponent("gui.annoyingvillagers.id_check.button_login"), (button) -> {
//            IdCheckScreen.textstate.put("textin:id_check", IdCheckScreen.id_check.getValue());
//            AnnoyingVillagers.PACKET_HANDLER.sendToServer(new IdCheckButtonMessage(0, this.x, this.y, this.z, IdCheckScreen.textstate));
...
//        this.button_x = new Button(this.leftPos + 62, this.topPos + 123, 51, 20, new TranslatableComponent("gui.annoyingvillagers.id_check.button_x"), (button) -> {
//            IdCheckScreen.textstate.put("textin:id_check", IdCheckScreen.id_check.getValue());
//            AnnoyingVillagers.PACKET_HANDLER.sendToServer(new IdCheckButtonMessage(1, this.x, this.y, this.z, IdCheckScreen.textstate));
