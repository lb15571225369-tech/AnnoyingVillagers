...
//    private static final ResourceLocation texture = new ResourceLocation(AnnoyingVillagers.MODID + ":textures/screens/music_search.png");
//
...
//        this.font.draw(posestack, new TranslatableComponent("gui.annoyingvillagers.music_search.label_name"), 13.0F, 12.0F, -12829636);
//    }
//
//    public void onClose() {
//        super.onClose();
...
//        MusicSearchScreen.music_seacrh = new EditBox(this.font, this.leftPos + 13, this.topPos + 24, 93, 20, new TranslatableComponent("gui.annoyingvillagers.music_search.music_seacrh")) {
//            {
//                this.setSuggestion((new TranslatableComponent("gui.annoyingvillagers.music_search.music_seacrh")).getString());
//            }
//
...
//        this.button_seacrh = new Button(this.leftPos + 30, this.topPos + 60, 56, 20, new TranslatableComponent("gui.annoyingvillagers.music_search.button_seacrh"), (button) -> {
//            MusicSearchScreen.textstate.put("textin:music_seacrh", MusicSearchScreen.music_seacrh.getValue());
//            AnnoyingVillagers.PACKET_HANDLER.sendToServer(new MusicSearchButtonMessage(0, this.x, this.y, this.z, MusicSearchScreen.textstate));
