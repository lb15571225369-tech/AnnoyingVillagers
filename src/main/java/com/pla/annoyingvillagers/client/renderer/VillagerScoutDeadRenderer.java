...
public class VillagerScoutDeadRenderer extends HumanoidMobRenderer<VillagerScoutDeadEntity, HumanoidModel<VillagerScoutDeadEntity>> {

    public VillagerScoutDeadRenderer(Context context) {
