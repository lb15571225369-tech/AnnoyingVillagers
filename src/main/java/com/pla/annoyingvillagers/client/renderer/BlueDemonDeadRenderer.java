...
public class BlueDemonDeadRenderer extends HumanoidMobRenderer<BlueDemonDeadEntity, HumanoidModel<BlueDemonDeadEntity>> {

    public BlueDemonDeadRenderer(Context context) {
