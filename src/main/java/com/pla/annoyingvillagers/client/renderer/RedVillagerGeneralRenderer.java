...
public class RedVillagerGeneralRenderer extends HumanoidMobRenderer<RedVillagerGeneralEntity, PlayerModel<RedVillagerGeneralEntity>> {
    ...
    public RedVillagerGeneralRenderer(Context context) {
        ...
        ArrowLayer<RedVillagerGeneralEntity, PlayerModel<RedVillagerGeneralEntity>> arrowLayer = new ArrowLayer<>(context, this);
