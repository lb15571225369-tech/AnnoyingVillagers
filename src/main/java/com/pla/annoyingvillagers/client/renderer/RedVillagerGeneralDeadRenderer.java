...
public class RedVillagerGeneralDeadRenderer extends HumanoidMobRenderer<RedVillagerGeneralDeadEntity, HumanoidModel<RedVillagerGeneralDeadEntity>> {

    public RedVillagerGeneralDeadRenderer(Context context) {
