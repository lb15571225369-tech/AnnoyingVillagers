...
public class SledgehammerHerobrineRenderer extends HumanoidMobRenderer<SledgehammerHerobrineEntity, HumanoidModel<SledgehammerHerobrineEntity>> {

    public SledgehammerHerobrineRenderer(Context context) {
