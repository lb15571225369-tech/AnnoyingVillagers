...
public class AegisHerobrineRenderer extends HumanoidMobRenderer<AegisHerobrineEntity, HumanoidModel<AegisHerobrineEntity>> {

    public AegisHerobrineRenderer(Context context) {
        ...
        this.addLayer(new EyesLayer<AegisHerobrineEntity, HumanoidModel<AegisHerobrineEntity>>(this) {
