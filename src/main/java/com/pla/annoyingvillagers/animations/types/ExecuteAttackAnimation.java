...
public class ExecuteAttackAnimation extends AttackAnimation {
    ...
    public ExecuteAttackAnimation(float f, String s, Armature armature, boolean flag, Phase... aphase) {
        super(f, s, armature, aphase);
    }

    public ExecuteAttackAnimation(float f, String s, Armature armature, Phase... aphase) {
        super(f, s, armature, aphase);
