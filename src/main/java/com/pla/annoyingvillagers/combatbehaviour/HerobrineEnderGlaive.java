                                    ...
                                    Behavior.builder()
                                            ...
                                            .addNextBehavior(
                                                    Behavior.builder()
                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                            .withinDistance(0.0D, 6.0D)
                                                            .animationBehavior(AVAnimations.CLONE_ANTITHEUS_AUTO_1, 0.0F)
                                                            .addNextBehavior(
                                                                    Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                            .withinDistance(0.0D, 6.0D)
                                                                            .animationBehavior(AVAnimations.CLONE_ANTITHEUS_AUTO_2, 0.0F)
                                                                            .addNextBehavior(
                                                                                    Behavior.builder()
                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                            .withinDistance(0.0D, 8.0D)
                                                                                            .animationBehavior(AVAnimations.CLONE_ANTITHEUS_GUILLOTINE, 0.0F)
                                                                            )
                                                            )
                                            )
                            )
                                                    ...
                                                    Behavior.builder()
                                                            ...
                                                            .addNextBehavior(
                                                                    Behavior.builder()
                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                            .withinDistance(0.0D, 6.0D)
                                                                            .animationBehavior(AVAnimations.CLONE_ANTITHEUS_AUTO_3, 0.0F)
                                                                            .addNextBehavior(
                                                                                    Behavior.builder()
                                                                                            .custom(CombatCommon::canPerformNormalAttackLogic)
                                                                                            .withinDistance(0.0D, 8.0D)
                                                                                            .animationBehavior(AVAnimations.CLONE_ANTITHEUS_AUTO_4, 0.0F)
                                                                            )
                                                            )
                                            )
                            )
