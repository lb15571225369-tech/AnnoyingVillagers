                                            ...
                                            .addNextBehavior(
                                                    Behavior.builder()
                                                            ...
                                                            .addNextBehavior(
                                                                    Behavior.builder()
                                                                            .withinDistance(0.0D, 2.0D)
                                                                            .animationBehavior(AVAnimations.DUAL_SWORD_AUTO3, 0.0F)
                                                                            .addNextBehavior(
                                                                                    Behavior.builder()
                                                                                            .withinDistance(0.0D, 2.0D)
                                                                                            .animationBehavior(AVAnimations.DUAL_SWORD_AUTO4, 0.0F)
                                                                                            .addNextBehavior(
                                                                                                    Behavior.builder()
                                                                                                            .withinDistance(0.0D, 2.0D)
                                                                                                            .animationBehavior(AVAnimations.DUAL_SWORD_AUTO5, 0.0F)
                                                                                            )
                                                                            )
                                                            )
                                            )
