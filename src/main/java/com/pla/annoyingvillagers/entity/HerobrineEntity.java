...
import com.pla.annoyingvillagers.procedures.HerobrineDangShanDianJiZhongShiTiShiProcedure;
...
import com.pla.annoyingvillagers.procedures.HerobrineDangShiTiSiWangShiProcedure;
...
public class HerobrineEntity extends Monster {
    ...
    public static void addLivingEntityToBiomes(BiomeLoadingEvent biomeloadingevent) {
        if (HerobrineEntity.SPAWN_BIOMES.contains(biomeloadingevent.getName())) {
            biomeloadingevent.getSpawns().getSpawner(MobCategory.MONSTER).add(new SpawnerData((EntityType) AnnoyingVillagersModEntities.HEROBRINE.get(), 1, 1, 1));
        }
    ...
    public void thunderHit(ServerLevel serverlevel, LightningBolt lightningbolt) {
        ...
        HerobrineDangShanDianJiZhongShiTiShiProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
    }
    ...
    public void die(DamageSource damagesource) {
        ...
        HerobrineDangShiTiSiWangShiProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
    }
