...
public class BlueDemonREntity extends Monster {

    public BlueDemonREntity(SpawnEntity spawnentity, Level level) {
        this((EntityType) AnnoyingVillagersModEntities.BLUE_DEMON_R.get(), level);
    }

    public BlueDemonREntity(EntityType<BlueDemonREntity> entitytype, Level level) {
