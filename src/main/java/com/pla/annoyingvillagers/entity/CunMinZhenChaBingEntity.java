...
public class CunMinZhenChaBingEntity extends PathfinderMob {
    ...
    public CunMinZhenChaBingEntity(SpawnEntity spawnentity, Level level) {
        this((EntityType) AnnoyingVillagersModEntities.CUN_MIN_ZHEN_CHA_BING.get(), level);
    }

    public CunMinZhenChaBingEntity(EntityType<CunMinZhenChaBingEntity> entitytype, Level level) {
...
//        this.targetSelector.addGoal(13, new NearestAttackableTargetGoal(this, WanJia1Entity.class, true, false));
//        this.targetSelector.addGoal(14, new NearestAttackableTargetGoal(this, MrcolderEntity.class, true, false));
//        this.targetSelector.addGoal(15, new NearestAttackableTargetGoal(this, MrMudgeMonkeyEntity.class, true, true));
