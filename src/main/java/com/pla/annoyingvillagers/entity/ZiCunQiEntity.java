...
public class ZiCunQiEntity extends PathfinderMob {
    ...
    public static void addLivingEntityToBiomes(BiomeLoadingEvent biomeloadingevent) {
        biomeloadingevent.getSpawns().getSpawner(MobCategory.CREATURE).add(new SpawnerData((EntityType) AnnoyingVillagersModEntities.ZI_CUN_QI.get(), 3, 1, 1));
    }

    public ZiCunQiEntity(SpawnEntity spawnentity, Level level) {
        this((EntityType) AnnoyingVillagersModEntities.ZI_CUN_QI.get(), level);
    }

    public ZiCunQiEntity(EntityType<ZiCunQiEntity> entitytype, Level level) {
        ...
        this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike) AnnoyingVillagersModItems.ZICUNQITOUKUI.get()));
        this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike) AnnoyingVillagersModItems.ZI_CUN_QI_KUI_JIA_CHESTPLATE.get()));
        this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike) AnnoyingVillagersModItems.ZI_CUN_QI_KUI_JIA_LEGGINGS.get()));
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack((ItemLike) AnnoyingVillagersModItems.ZI_CUN_QI_KUI_JIA_BOOTS.get()));
    }
...
//        this.targetSelector.addGoal(28, new NearestAttackableTargetGoal(this, ZiCunQiFuLuEntity.class, true, true));
    ...
    public InteractionResult mobInteract(Player player, InteractionHand interactionhand) {
        ...
        ZiCunQiDangYouJiShiTiShiProcedure.execute(level, d0, d1, d2, this);
    ...
    public static void init() {
        SpawnPlacements.register((EntityType) AnnoyingVillagersModEntities.ZI_CUN_QI.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entitytype, serverlevelaccessor, mobspawntype, blockpos, random) -> {
