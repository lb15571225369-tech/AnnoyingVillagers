...
public class NullShovelEntity extends Monster {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new RandomStrollGoal(this, 0.4D, 20) {
            protected Vec3 getPosition() {
                ...
                double d0 = NullShovelEntity.this.getX() + (double) ((random.nextFloat() * 2.0F - 1.0F));
                double d1 = NullShovelEntity.this.getY() + (double) ((random.nextFloat() * 2.0F - 1.0F));
                double d2 = NullShovelEntity.this.getZ() + (double) ((random.nextFloat() * 2.0F - 1.0F));
        ...
        this.goalSelector.addGoal(7, new Goal() {
            ...
            public void tick() {
                ...
                if (NullShovelEntity.this.getBoundingBox().intersects(livingentity.getBoundingBox())) {
                    ...
                    double d0 = NullShovelEntity.this.distanceToSqr(livingentity);
    ...
    public void tick() {
        super.tick();
        if (this.getItemBySlot(EquipmentSlot.MAINHAND).getItem() != AnnoyingVillagersModItems.NULL_SHOVEL.get()) {
