...
public class NullAxeEntity extends Monster {
    ...
    public void tick() {
        super.tick();
        if (this.getMainHandItem().getItem() != Items.DIAMOND_AXE) {
            this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(Items.DIAMOND_AXE));
        }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new RandomStrollGoal(this, 0.4D, 20) {
            protected Vec3 getPosition() {
                ...
                double d0 = NullAxeEntity.this.getX() + (double) ((random.nextFloat() * 2.0F - 1.0F));
                double d1 = NullAxeEntity.this.getY() + (double) ((random.nextFloat() * 2.0F - 1.0F));
                double d2 = NullAxeEntity.this.getZ() + (double) ((random.nextFloat() * 2.0F - 1.0F));
        ...
        this.goalSelector.addGoal(7, new Goal() {
            ...
            public void tick() {
                ...
                if (NullAxeEntity.this.getBoundingBox().intersects(livingentity.getBoundingBox())) {
                    ...
                    double d0 = NullAxeEntity.this.distanceToSqr(livingentity);
