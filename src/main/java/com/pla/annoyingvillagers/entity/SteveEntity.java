...
public class SteveEntity extends PathfinderMobInventory {
    ...
    public boolean hurt(DamageSource damagesource, float f) {
        SteveOnHurtProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
    ...
    public static void init() {
        SpawnPlacements.register((EntityType) AnnoyingVillagersModEntities.STEVE.get(), Type.ON_GROUND, Types.MOTION_BLOCKING_NO_LEAVES, (entitytype, serverlevelaccessor, mobspawntype, blockpos, random) -> {
