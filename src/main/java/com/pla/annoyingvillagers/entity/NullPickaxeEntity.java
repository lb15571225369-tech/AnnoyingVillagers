...
public class NullPickaxeEntity extends Monster {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new RandomStrollGoal(this, 0.4D, 20) {
            protected Vec3 getPosition() {
                ...
                double d0 = NullPickaxeEntity.this.getX() + (double) ((random.nextFloat() * 2.0F - 1.0F));
                double d1 = NullPickaxeEntity.this.getY() + (double) ((random.nextFloat() * 2.0F - 1.0F));
                double d2 = NullPickaxeEntity.this.getZ() + (double) ((random.nextFloat() * 2.0F - 1.0F));
        ...
        this.goalSelector.addGoal(7, new Goal() {
            ...
            public void tick() {
                ...
                if (NullPickaxeEntity.this.getBoundingBox().intersects(livingentity.getBoundingBox())) {
                    ...
                    double d0 = NullPickaxeEntity.this.distanceToSqr(livingentity);
    ...
    public void tick() {
        super.tick();
        if (this.getItemBySlot(EquipmentSlot.MAINHAND).getItem() != AnnoyingVillagersModItems.NULL_PICKAXE.get()) {
