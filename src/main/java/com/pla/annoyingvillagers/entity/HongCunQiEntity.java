...
public class HongCunQiEntity extends PathfinderMob {
    ...
    public HongCunQiEntity(SpawnEntity spawnentity, Level level) {
        this((EntityType) AnnoyingVillagersModEntities.HONG_CUN_QI.get(), level);
    }

    public HongCunQiEntity(EntityType<HongCunQiEntity> entitytype, Level level) {
        ...
        this.setItemSlot(EquipmentSlot.HEAD, new ItemStack((ItemLike) AnnoyingVillagersModItems.HONGCUNQITOUKUI.get()));
        this.setItemSlot(EquipmentSlot.CHEST, new ItemStack((ItemLike) AnnoyingVillagersModItems.HONG_CUN_QIHELMET_CHESTPLATE.get()));
        this.setItemSlot(EquipmentSlot.LEGS, new ItemStack((ItemLike) AnnoyingVillagersModItems.HONG_CUN_QIHELMET_LEGGINGS.get()));
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack((ItemLike) AnnoyingVillagersModItems.HONG_CUN_QIHELMET_BOOTS.get()));
    }
...
//        this.targetSelector.addGoal(11, new NearestAttackableTargetGoal(this, FennudeshidifuEntity.class, true, false));
...
//        this.targetSelector.addGoal(26, new NearestAttackableTargetGoal(this, CunZhenFuLuEntity.class, true, true));
//        this.targetSelector.addGoal(27, new NearestAttackableTargetGoal(this, LanCunQiFuLuEntity.class, true, true));
//        this.targetSelector.addGoal(28, new NearestAttackableTargetGoal(this, LvcunqifuluEntity.class, true, true));
//        this.targetSelector.addGoal(29, new NearestAttackableTargetGoal(this, HongCunQiFuLuEntity.class, true, true));
//        this.targetSelector.addGoal(30, new NearestAttackableTargetGoal(this, ZiCunQiFuLuEntity.class, true, true));
    }
