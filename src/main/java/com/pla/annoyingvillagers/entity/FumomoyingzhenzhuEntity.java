...
public class FumomoyingzhenzhuEntity extends AbstractArrow implements ItemSupplier {
    ...
    public FumomoyingzhenzhuEntity(SpawnEntity spawnentity, Level level) {
        super((EntityType) AnnoyingVillagersModEntities.FUMOMOYINGZHENZHU.get(), level);
    }

    public FumomoyingzhenzhuEntity(EntityType<? extends FumomoyingzhenzhuEntity> entitytype, Level level) {
        super(entitytype, level);
    }

    public FumomoyingzhenzhuEntity(EntityType<? extends FumomoyingzhenzhuEntity> entitytype, double d0, double d1, double d2, Level level) {
        super(entitytype, d0, d1, d2, level);
    }

    public FumomoyingzhenzhuEntity(EntityType<? extends FumomoyingzhenzhuEntity> entitytype, LivingEntity livingentity, Level level) {
    ...
    public static FumomoyingzhenzhuEntity shoot(Level level, LivingEntity livingentity, Random random, float f, double d0, int i) {
        FumomoyingzhenzhuEntity fumomoyingzhenzhuentity = new FumomoyingzhenzhuEntity((EntityType) AnnoyingVillagersModEntities.FUMOMOYINGZHENZHU.get(), livingentity, level);
    ...
    public static FumomoyingzhenzhuEntity shoot(LivingEntity livingentity, LivingEntity livingentity1) {
        FumomoyingzhenzhuEntity fumomoyingzhenzhuentity = new FumomoyingzhenzhuEntity((EntityType) AnnoyingVillagersModEntities.FUMOMOYINGZHENZHU.get(), livingentity, livingentity.level);
