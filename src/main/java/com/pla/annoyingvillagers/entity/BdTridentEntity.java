...
public class BdTridentEntity extends PathfinderMob {

    public BdTridentEntity(SpawnEntity spawnentity, Level level) {
        this((EntityType) AnnoyingVillagersModEntities.BD_TRIDENT.get(), level);
    }

    public BdTridentEntity(EntityType<BdTridentEntity> entitytype, Level level) {
