...
import com.pla.annoyingvillagers.procedures.NoneobDangShiTiZaiFangKuaiZhongPengZhuangShiProcedure;
import com.pla.annoyingvillagers.procedures.NoneobFangZhiFangKuaiShiProcedure;
...
public class NoneobBlock extends Block {
    ...
    public void onPlace(BlockState blockstate, Level level, BlockPos blockpos, BlockState blockstate1, boolean flag) {
        ...
        NoneobFangZhiFangKuaiShiProcedure.execute(level, (double) blockpos.getX(), (double) blockpos.getY(), (double) blockpos.getZ());
    }

    public void entityInside(BlockState blockstate, Level level, BlockPos blockpos, Entity entity) {
        super.entityInside(blockstate, level, blockpos, entity);
        NoneobDangShiTiZaiFangKuaiZhongPengZhuangShiProcedure.execute(level, entity);
    }
