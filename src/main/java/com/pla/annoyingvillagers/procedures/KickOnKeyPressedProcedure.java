                    ...
                    if (entity.getPersistentData().getInt(NBT_KICK_CD) == 0) {
                        ...
                        if (entity.isShiftKeyDown()) {
                            if (entity.isSprinting()) {
                                ...
                                if (playerpatch != null && playerpatch.getHoldingItemCapability(InteractionHand.MAIN_HAND).getWeaponCategory() == WeaponCategories.FIST && !entity.level().isClientSide() && entity.getServer() != null) {
                                    LivingEntityPatch<?> livingEntityPatch = EpicFightCapabilities.getEntityPatch(entity, LivingEntityPatch.class);
                                    if (livingEntityPatch != null) {
