...
@EventBusSubscriber
public class WrestlingProcedure {
    ...
    public static void onRightClickEntity(EntityInteract entityinteract) {
        if (entityinteract.getHand() == entityinteract.getEntity().getUsedItemHand()) {
            execute(entityinteract.getEntity(), entityinteract.getEntity().level());
        }
    }
        ...
        if (!((LivingEntity) livingentitypatch.getOriginal()).hasEffect((MobEffect) AnnoyingVillagersModMobEffects.EC.get()) && !serverplayer.getPersistentData().getBoolean("kick_x") && ((LivingEntity) livingentitypatch.getOriginal()).isAlive() && playerpatch.getHoldingItemCapability(InteractionHand.MAIN_HAND).getWeaponCategory() == WeaponCategories.FIST) {
            ...
            if (!serverplayer.isSprinting()) {
                if (serverplayer.isShiftKeyDown()) {
                    ...
                    serverplayer.addEffect(new MobEffectInstance((MobEffect) AnnoyingVillagersModMobEffects.EC.get(), 80, 0, false, false));
                    ((LivingEntity) livingentitypatch.getOriginal()).addEffect(new MobEffectInstance((MobEffect) AnnoyingVillagersModMobEffects.EC.get(), 160, 0, false, false));
                    ((LivingEntity) livingentitypatch.getOriginal()).addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 60, 10, false, false));
                    serverplayer.teleportTo(((LivingEntity) livingentitypatch.getOriginal()).getX() + vec3.x * 1.0D, ((LivingEntity) livingentitypatch.getOriginal()).getY(), ((LivingEntity) livingentitypatch.getOriginal()).getZ() + vec3.z * 1.0D);
                ...
                playerpatch.setGrapplingTarget((LivingEntity) livingentitypatch.getOriginal());
                serverplayer.addEffect(new MobEffectInstance((MobEffect) EpicFightMobEffects.STUN_IMMUNITY.get(), 100, 0, false, false));
                serverplayer.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 70, 10, false, false));
                serverplayer.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 70, 50, false, false));
                ((LivingEntity) livingentitypatch.getOriginal()).addEffect(new MobEffectInstance((MobEffect) EpicFightMobEffects.STUN_IMMUNITY.get(), 150, 0, false, false));
                serverplayer.addEffect(new MobEffectInstance((MobEffect) AnnoyingVillagersModMobEffects.EC.get(), 110, 0, false, false));
                ((LivingEntity) livingentitypatch.getOriginal()).addEffect(new MobEffectInstance((MobEffect) AnnoyingVillagersModMobEffects.EC.get(), 300, 0, false, false));
                ((LivingEntity) livingentitypatch.getOriginal()).addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 80, 10, false, false));
                serverplayer.teleportTo(((LivingEntity) livingentitypatch.getOriginal()).getX() + vec3.x * 3.0D, ((LivingEntity) livingentitypatch.getOriginal()).getY(), ((LivingEntity) livingentitypatch.getOriginal()).getZ() + vec3.z * 3.0D);
                serverplayer.lookAt(Anchor.EYES, new Vec3(((LivingEntity) livingentitypatch.getOriginal()).getX(), ((LivingEntity) livingentitypatch.getOriginal()).getY() + 1.0D, ((LivingEntity) livingentitypatch.getOriginal()).getZ()));
                ((LivingEntity) livingentitypatch.getOriginal()).lookAt(Anchor.EYES, new Vec3(serverplayer.getX(), serverplayer.getY() + 1.0D, serverplayer.getZ()));
                serverplayer.addEffect(new MobEffectInstance(MobEffects.BLINDNESS, 20, 5, false, false));
                ((LivingEntity) livingentitypatch.getOriginal()).addEffect(new MobEffectInstance(MobEffects.BLINDNESS, 20, 5, false, false));
                playerpatch.playAnimationSynchronized(AVAnimations.HARD_KICK, 0.0F);
                livingentitypatch.playAnimationSynchronized(AVAnimations.HARD_KICK_HIT, 0.0F);
            }
        }
