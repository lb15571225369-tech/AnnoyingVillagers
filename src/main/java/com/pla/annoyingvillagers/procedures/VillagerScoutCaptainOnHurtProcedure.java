...
public class VillagerScoutCaptainOnHurtProcedure {
        ...
        if (entity != null) {
            ...
            while(iterator.hasNext()) {
                ...
                if (entity1 == livingentity) {
                    ...
                    itemstack1.enchant(Enchantments.SHARPNESS, 3);
                    new DelayedTask(120) {
                        @Override
                        public void run() {
                            if (entity instanceof LivingEntity) {
                                ...
                                new DelayedTask(80) {
                                    public void run() {
                                        ...
                                        if (Math.random() <= 0.2D) {
                                            ...
                                            if (entity instanceof LivingEntity) {
                                                livingentity5 = (LivingEntity)entity;
                                                itemstack4 = new ItemStack(Items.IRON_SWORD);
                                                itemstack4.setCount(1);
                                                livingentity5.setItemInHand(InteractionHand.MAIN_HAND, itemstack4);
                                                if (livingentity5 instanceof Player) {
                                                    player2 = (Player)livingentity5;
                    ...
                    if (f <= 7.0F && levelaccessor instanceof Level) {
                        ...
                        if (!level.isClientSide()) {
                            level.playSound((Player)null, new BlockPos(d0, d1, d2), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.item.break")), SoundSource.NEUTRAL, 1.0F, 1.0F);
                        } else {
