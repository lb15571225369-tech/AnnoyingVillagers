...
public class VillagerScoutSmartSkillProcedure {
    ...
    public static void execute(LevelAccessor levelaccessor, final double d0, final double d1, final double d2, final Entity entity) {
        if (entity != null) {
            ...
            List<Entity> list = (List)levelaccessor.getEntitiesOfClass(Entity.class, (new AABB(vec3, vec3)).inflate(20.0D), (entity1) -> {
                ...
                return entity1.distanceToSqr(finalVec);
            ...
            while(iterator.hasNext()) {
                ...
                if (entity1 == livingentity1 && entity.isAlive()) {
                                        ...
                                        public void run() {
                                            ...
                                            if (levelaccessor1 instanceof Level) {
                                                ...
                                                if (!level1.isClientSide()) {
                                                    level1.playSound((Player)null, new BlockPos(d0, d1, d2), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("minecraft", "entity.arrow.shoot")), SoundSource.NEUTRAL, 1.0F, 1.0F);
                                                } else {
            ...
            Vec3 finalVec1 = vec3;
            list = (List)levelaccessor.getEntitiesOfClass(Entity.class, (new AABB(vec3, vec3)).inflate(2.5D), (entity2) -> {
                return true;
