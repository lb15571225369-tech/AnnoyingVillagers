        ...
        if (entity != null && entity1 != null) {
            if (levelaccessor.getLevelData().getGameRules().getBoolean(AnnoyingVillagersModGameRules.MUSIC_BOX) && entity instanceof Player && entity1 instanceof Player) {
                if (!entity1.level.isClientSide() && entity1.getServer() != null) {
                    entity1.getServer().getCommands().performCommand(entity1.createCommandSourceStack().withSuppressedOutput().withPermission(4), "stopsound @s record annoying_villagers:music_box");
                }
                ...
                ((<undefinedtype>)(new Object() {
                    ...
                    private void run() {
                        ...
                        if (!entity2.level.isClientSide() && entity2.getServer() != null) {
                            entity2.getServer().getCommands().performCommand(entity2.createCommandSourceStack().withSuppressedOutput().withPermission(4), "playsound annoying_villagers:music_box_win record @s");
                        }
