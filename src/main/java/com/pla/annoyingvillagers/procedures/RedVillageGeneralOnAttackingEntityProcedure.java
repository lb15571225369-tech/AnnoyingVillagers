...
public class RedVillageGeneralOnAttackingEntityProcedure {
                ...
                if (itemstack.getItem() == Blocks.OBSIDIAN.asItem()) {
                    ...
                    if (levelaccessor instanceof Level) {
                        ...
                        if (!level.isClientSide()) {
                            level.playSound((Player)null, new BlockPos(d0, d1, d2), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("item.armor.equip_leather")), SoundSource.NEUTRAL, 1.0F, 1.0F);
                        } else {
                            level.playLocalSound(d0, d1, d2, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("item.armor.equip_leather")), SoundSource.NEUTRAL, 1.0F, 1.0F, false);
                        }
                    }
                    ...
                    if (levelaccessor instanceof Level) {
                        level = (Level)levelaccessor;
                        if (!level.isClientSide()) {
                            level.playSound((Player)null, new BlockPos(d0, d1, d2), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.stone.place")), SoundSource.NEUTRAL, 1.0F, 1.0F);
                        } else {
                            level.playLocalSound(d0, d1, d2, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.stone.place")), SoundSource.NEUTRAL, 1.0F, 1.0F, false);
                        }
                    }
                    ...
                    if (itemstack.getItem() == Blocks.OBSIDIAN.asItem()) {
                        ...
                        Entity entity2 = levelaccessor.getEntitiesOfClass(
                                        Player.class,
                                        AABB.ofSize(new Vec3(d0, d1, d2), 5.0D, 5.0D, 5.0D),
                                        player -> true
                                ).stream()
