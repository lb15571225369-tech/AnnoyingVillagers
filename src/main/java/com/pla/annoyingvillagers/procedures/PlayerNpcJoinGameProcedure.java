        ...
        if (entity != null) {
            ...
            if (ForgeRegistries.ENTITY_TYPES.getKey(entity.getType()).toString().equals("player_mobs:player_mob")) {
                if (!entity.level().isClientSide() && entity.getServer() != null) {
                    List<String> commands = EquipmentDataLoader.getEquipCommands(0.85f, entity);
            ...
            if ((ForgeRegistries.ENTITY_TYPES.getKey(entity.getType()).toString().equals("minecraft:skeleton") || ForgeRegistries.ENTITY_TYPES.getKey(entity.getType()).toString().equals("minecraft:stray")) && !entity.level().isClientSide() && entity.getServer() != null) {
                if (!entity.level().isClientSide() && entity.getServer() != null) {
                    if (!entity.level().isClientSide() && entity.getServer() != null) {
                        try {
                            entity.getServer().getCommands().getDispatcher().execute(
            ...
            if (ForgeRegistries.ENTITY_TYPES.getKey(entity.getType()).toString().equals("minecraft:vindicator") && !entity.level().isClientSide() && entity.getServer() != null) {
                if (!entity.level().isClientSide() && entity.getServer() != null) {
                    try {
                        entity.getServer().getCommands().getDispatcher().execute(
                                "data merge entity @s {CanPickUpLoot: 1b}",
