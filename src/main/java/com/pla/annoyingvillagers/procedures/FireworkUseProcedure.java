                    ...
                    if (itemstack.getItem() == Items.FIREWORK_ROCKET) {
                        ...
                        if (levelaccessor instanceof Level) {
                            ...
                            if (!level.isClientSide()) {
                                level.playSound((Player)null, new BlockPos(d0, d1, d2), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("minecraft", "entity.firework_rocket.launch")), SoundSource.NEUTRAL, 1.0F, 2.0F);
                            } else {
                            ...
                            public void run() {
                                ...
                                if (levelaccessor1 instanceof Level) {
                                    ...
                                    if (!level1.isClientSide()) {
                                        level1.playSound((Player)null, new BlockPos(d0, d1, d2), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("minecraft", "entity.experience_orb.pickup")), SoundSource.NEUTRAL, 1.0F, 2.0F);
                                    } else {
