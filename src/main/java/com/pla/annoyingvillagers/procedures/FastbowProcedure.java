...
//                                public Projectile getArrow(Level level1, Entity entity1, float f, int i) {
//                                    Arrow arrow = new Arrow(EntityType.ARROW, level1);
//
//                                    arrow.setOwner(entity1);
//                                    arrow.setBaseDamage((double)f);
...
//
//
//                            Projectile projectile = ((<undefinedtype>)object).getArrow(level, entity, (float)(1 + EnchantmentHelper.getItemEnchantmentLevel(enchantment1, itemstack2)), 0);
//
