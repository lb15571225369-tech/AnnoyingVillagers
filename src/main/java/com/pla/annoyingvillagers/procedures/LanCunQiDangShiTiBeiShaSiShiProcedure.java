    ...
    public static void execute(LevelAccessor levelaccessor, final double d0, final double d1, final double d2, final Entity entity) {
        if (entity != null) {
            ...
            if (Math.random() <= 0.4D && !levelaccessor.isClientSide() && levelaccessor.getServer() != null) {
                levelaccessor.getServer().getPlayerList().broadcastMessage(new TextComponent("<\u6751\u6c11\u84dd\u9a91\u5175> \u8fd9\u662f\u534f\u8bae\u7684\u4e00\u90e8\u5206......"), ChatType.SYSTEM, Util.NIL_UUID);
            }
            ...
            if (Math.random() <= 0.1D) {
                ...
                if (!levelaccessor.isClientSide() && levelaccessor.getServer() != null) {
                    levelaccessor.getServer().getPlayerList().broadcastMessage(new TextComponent("<\u6751\u6c11\u84dd\u9a91\u5175> \u8bf7\u6c42\u652f\u63f4\uff01"), ChatType.SYSTEM, Util.NIL_UUID);
                }
