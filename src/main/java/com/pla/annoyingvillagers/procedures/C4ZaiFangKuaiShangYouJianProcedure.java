...
//                                            level1.playSound((Player)null, new BlockPos(d0, d1, d2), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation(AnnoyingVillagers.MODID + ":c4defused")), SoundSource.NEUTRAL, 1.0F, 1.0F);
//                                        } else {
//                                            level1.playLocalSound(d0, d1, d2, (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation(AnnoyingVillagers.MODID + ":c4defused")), SoundSource.NEUTRAL, 1.0F, 1.0F, false);
//                                        }
//                                    }
//
//                                    if (entity instanceof ServerPlayer) {
//                                        ServerPlayer serverplayer = (ServerPlayer)entity;
//                                        Advancement advancement = serverplayer.server.getAdvancements().getAdvancement(new ResourceLocation(AnnoyingVillagers.MODID + ":onemoretime"));
