                ...
                if (EnchantmentHelper.getItemEnchantmentLevel(enchantment, itemstack) != 0) {
                    ...
                    if (levelaccessor instanceof Level) {
                        ...
                        if (!level.isClientSide()) {
                            level.playSound((Player)null, new BlockPos((int) d0, (int) d1, (int) d2), (SoundEvent)ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation(AnnoyingVillagers.MODID, "target_block_hit")), SoundSource.NEUTRAL, 1.0F, 1.0F);
                        } else {
