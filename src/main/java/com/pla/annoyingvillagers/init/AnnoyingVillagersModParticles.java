...
public class AnnoyingVillagersModParticles {
    ...
    public static void registerParticles(ParticleFactoryRegisterEvent particlefactoryregisterevent) {
        ...
        Minecraft.getInstance().particleEngine.register((SimpleParticleType) AnnoyingVillagersModParticleTypes.DIANHU.get(), DianhuParticle::provider);
        Minecraft.getInstance().particleEngine.register((SimpleParticleType) AnnoyingVillagersModParticleTypes.DIANHU_2.get(), Dianhu2Particle::provider);
