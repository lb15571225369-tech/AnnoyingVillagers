...
public class AnnoyingVillagersModEntityRenderers {
    ...
    public static void registerEntityRenderers(RegisterRenderers registerrenderers) {
        ...
        registerrenderers.registerEntityRenderer((EntityType) AnnoyingVillagersModEntities.PLAYER_MOB_DEAD.get(), PlayerMobDeadRenderer::new);
        ...
        registerrenderers.registerEntityRenderer((EntityType) AnnoyingVillagersModEntities.NULL_PICKAXE.get(), NullPickaxeRenderer::new);
