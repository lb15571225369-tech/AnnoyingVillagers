...
public class AnnoyingVillagersModEntityRenderers {
    ...
    public static void registerEntityRenderers(RegisterRenderers registerrenderers) {
        ...
        registerrenderers.registerEntityRenderer(AnnoyingVillagersModEntities.NOTCH.get(), NotchRenderer::new);
        registerrenderers.registerEntityRenderer(AnnoyingVillagersModEntities.NOTCH_ORBIT_ITEM.get(), NotchOrbitItemRenderer::new);
    }
    ...
    public static void onPatchedRenderer(PatchedRenderersEvent.Add add) {
        ...
        add.addPatchedEntityRenderer(AnnoyingVillagersModEntities.BLUE_DEMON.get(),
                (entitytype) -> (new PHumanoidRenderer<>(Meshes.BIPED, add.getContext(), entitytype))
                        .initLayerLast(add.getContext(), entitytype));
        add.addPatchedEntityRenderer(AnnoyingVillagersModEntities.NOTCH.get(),
                (entitytype) -> (new PHumanoidRenderer<>(Meshes.BIPED, add.getContext(), entitytype))
                        .initLayerLast(add.getContext(), entitytype));
    }
}
