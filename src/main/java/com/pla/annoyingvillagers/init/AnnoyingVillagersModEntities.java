...
public class AnnoyingVillagersModEntities {
    ...
    public static final RegistryObject<EntityType<BlueDemonThrownTrident>> BLUE_DEMON_THROWN_TRIDENT = register("blue_demon_thrown_trident", Builder.<BlueDemonThrownTrident>of(BlueDemonThrownTrident::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(4).updateInterval(20));
