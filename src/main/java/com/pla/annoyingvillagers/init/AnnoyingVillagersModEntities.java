...
public class AnnoyingVillagersModEntities {
    ...
    public static final RegistryObject<EntityType<FumomoyingzhenzhuEntity>> FUMOMOYINGZHENZHU = register("projectile_fumomoyingzhenzhu", Builder.<FumomoyingzhenzhuEntity>of(FumomoyingzhenzhuEntity::new, MobCategory.MISC).setCustomClientFactory(FumomoyingzhenzhuEntity::new).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).sized(0.5F, 0.5F));
