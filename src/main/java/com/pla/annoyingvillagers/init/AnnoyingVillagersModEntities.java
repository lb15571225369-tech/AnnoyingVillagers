...
public class AnnoyingVillagersModEntities {
    ...
    public static final RegistryObject<EntityType<NotchEntity>> NOTCH = register("notch", Builder.<NotchEntity>of(NotchEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(256).setUpdateInterval(3).setCustomClientFactory(NotchEntity::new).fireImmune().sized(0.6F, 1.8F));
    public static final RegistryObject<EntityType<NotchOrbitItemEntity>> NOTCH_ORBIT_ITEM = register("notch_orbit_item", Builder.<NotchOrbitItemEntity>of(NotchOrbitItemEntity::new, MobCategory.MISC).sized(0.5F, 0.5F).clientTrackingRange(64).updateInterval(2).fireImmune());
    ...
    public static void setPatch(EntityPatchRegistryEvent entityPatchRegistryEvent) {
        ...
        entityPatchRegistryEvent.getTypeEntry().put(AnnoyingVillagersModEntities.NOTCH.get(), (entity) -> NotchPatch::new);
    }
    ...
    public static void registerAttributes(EntityAttributeCreationEvent entityAttributeCreationEvent) {
        ...
        entityAttributeCreationEvent.put(AnnoyingVillagersModEntities.NOTCH.get(), NotchEntity.createAttributes().build());
    }
}
