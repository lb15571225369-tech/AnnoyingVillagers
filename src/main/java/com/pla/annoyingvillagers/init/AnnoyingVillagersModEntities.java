...
public class AnnoyingVillagersModEntities {
    ...
    public static final RegistryObject<EntityType<PurpleVillagerGeneralEntity>> PURPLE_VILLAGER_GENERAL = register("lu_cun_qi", Builder.<PurpleVillagerGeneralEntity>of(PurpleVillagerGeneralEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(128).setUpdateInterval(3).setCustomClientFactory(PurpleVillagerGeneralEntity::new).fireImmune().sized(0.6F, 1.8F));
    ...
    public static final RegistryObject<EntityType<GreenVillagerGeneralEntity>> GREEN_VILLAGER_GENERAL = register("zi_cun_qi", Builder.<GreenVillagerGeneralEntity>of(GreenVillagerGeneralEntity::new, MobCategory.CREATURE).setShouldReceiveVelocityUpdates(true).setTrackingRange(128).setUpdateInterval(3).setCustomClientFactory(GreenVillagerGeneralEntity::new).fireImmune().sized(0.6F, 1.8F));
    ...
    public static void registerAttributes(EntityAttributeCreationEvent entityattributecreationevent) {
        ...
        entityattributecreationevent.put((EntityType) AnnoyingVillagersModEntities.PURPLE_VILLAGER_GENERAL.get(), PurpleVillagerGeneralEntity.createAttributes().build());
        ...
        entityattributecreationevent.put((EntityType) AnnoyingVillagersModEntities.GREEN_VILLAGER_GENERAL.get(), GreenVillagerGeneralEntity.createAttributes().build());
    }
}
