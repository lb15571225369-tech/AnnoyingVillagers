...
public class AnnoyingVillagersModEntities {
    ...
    public static final RegistryObject<EntityType<HerobrineDragon>> HEROBRINE_DRAGON = register("herobrine_dragon", EntityType.Builder.of(HerobrineDragon::new, MobCategory.CREATURE).sized(HerobrineDragon.BASE_WIDTH, HerobrineDragon.BASE_HEIGHT).clientTrackingRange(10).updateInterval(3));
    ...
    public static void registerAttributes(EntityAttributeCreationEvent entityAttributeCreationEvent) {
        ...
        entityAttributeCreationEvent.put(AnnoyingVillagersModEntities.HEROBRINE_DRAGON.get(), HerobrineDragon.createAttributes().build());
    }
}
