...
public class AnnoyingVillagersModKeyMappings {
    ...
    public static final KeyMapping CHECK = new KeyMapping("key.annoyingvillagers.check", 78, "key.categories.gameplay") {
        private boolean isDownOld = false;

        public void setDown(boolean flag) {
            super.setDown(flag);
            if (this.isDownOld != flag && flag) {
                AnnoyingVillagers.PACKET_HANDLER.sendToServer(new CheckMessage(0, 0));
...
//    public static final KeyMapping MUSIC_PLAYER_OPEN = new KeyMapping("key.annoyingvillagers.music_player_open", 74, "key.categories.misc") {
//        private boolean isDownOld = false;
//
//        public void setDown(boolean flag) {
//            super.setDown(flag);
//            if (this.isDownOld != flag && flag) {
//                AnnoyingVillagers.PACKET_HANDLER.sendToServer(new MusicPlayerOpenMessage(0, 0));
...
//    public static final KeyMapping OPEN_EMOJI = new KeyMapping("key.annoyingvillagers.open_emoji", 320, "key.categories.misc") {
//        private boolean isDownOld = false;
//
//        public void setDown(boolean flag) {
//            super.setDown(flag);
//            if (this.isDownOld != flag && flag) {
//                AnnoyingVillagers.PACKET_HANDLER.sendToServer(new OpenEmojiMessage(0, 0));
