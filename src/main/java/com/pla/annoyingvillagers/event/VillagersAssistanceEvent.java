            ...
            if (ForgeRegistries.ENTITY_TYPES.getKey(entity.getType()).toString().equals("minecraft:villager") && levelaccessor instanceof ServerLevel) {
                ...
                if (serverlevel.isRaided(new BlockPos((int) d0, (int) d1, (int) d2)) && Math.random() <= 0.2D) {
                    if (!levelaccessor.isClientSide() && levelaccessor.getServer() != null) {
                        levelaccessor.getServer().getPlayerList().broadcastSystemMessage(Component.literal("<" + Component.translatable("entity.minecraft.villager").getString() + "> " + Component.translatable("message.annoyingvillagers.villager_help").getString()), false);
                    }
