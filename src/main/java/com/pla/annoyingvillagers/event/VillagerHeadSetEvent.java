                    ...
                    if (!entity.getPersistentData().getBoolean("villager_head")) {
                        if (!entity.getPersistentData().getBoolean("villager_head_used")) {
                            ...
                            if (entity instanceof Player) {
                                ...
                                if (!player.level().isClientSide()) {
                                    player.displayClientMessage(Component.translatable("message.annoyingvillagers.switched_attack_mode"), false);
                                }
                            }
                            ...
                            player = (Player)entity;
                            if (!player.level().isClientSide()) {
                                player.displayClientMessage(Component.translatable("message.annoyingvillagers.on_cooldown"), true);
                            }
                        }
                        ...
                        if (!entity.getPersistentData().getBoolean("villager_head_used")) {
                            ...
                            if (entity instanceof Player) {
                                player = (Player)entity;
                                if (!player.level().isClientSide()) {
                                    player.displayClientMessage(Component.translatable("message.annoyingvillagers.switched_disguise_mode"), false);
                                }
                            }
