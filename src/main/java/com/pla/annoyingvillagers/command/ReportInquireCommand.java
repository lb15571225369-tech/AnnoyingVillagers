...
import com.pla.annoyingvillagers.procedures.ReportLoadProcedure;

@EventBusSubscriber
public class ReportInquireCommand {

    @SubscribeEvent
    public static void registerCommand(RegisterCommandsEvent registercommandsevent) {
        registercommandsevent.getDispatcher().register((LiteralArgumentBuilder) Commands.literal("report-inquire").then(Commands.argument("name", StringArgumentType.string()).executes((commandcontext) -> {
            ...
            ReportLoadProcedure.execute(commandcontext, (Entity) object);
            return 0;
        })));
    }
}
