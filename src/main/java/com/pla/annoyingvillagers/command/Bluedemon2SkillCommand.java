...
//import com.pla.annoyingvillagers.procedures.Bluedemon2SkillEffectProcedure;
//
//@EventBusSubscriber
//public class Bluedemon2SkillCommand {
//
//    @SubscribeEvent
//    public static void registerCommand(RegisterCommandsEvent registercommandsevent) {
//        registercommandsevent.getDispatcher().register((LiteralArgumentBuilder) ((LiteralArgumentBuilder) Commands.literal("bluedemon2skill").requires((commandsourcestack) -> {
...
//
//            Bluedemon2SkillEffectProcedure.execute(serverlevel, d0, d1, d2, (Entity) object);
//            return 0;
//        }));
//    }
//}
