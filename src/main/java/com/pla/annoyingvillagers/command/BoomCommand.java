...
//import com.pla.annoyingvillagers.procedures.BoomSizeProcedure;
//
//@EventBusSubscriber
...
//        registercommandsevent.getDispatcher().register((LiteralArgumentBuilder) ((LiteralArgumentBuilder) Commands.literal("boom").requires((commandsourcestack) -> {
//            return commandsourcestack.hasPermission(4);
//        })).then(Commands.argument("size", DoubleArgumentType.doubleArg()).then(Commands.argument("xyz", BlockPosArgument.blockPos()).executes((commandcontext) -> {
...
//
//            BoomSizeProcedure.execute(serverlevel, commandcontext);
//            return 0;
//        }))));
//    }
//}
