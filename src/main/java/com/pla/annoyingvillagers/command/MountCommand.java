...
import com.pla.annoyingvillagers.procedures.MountUseProcedure;
...
public class MountCommand {
    ...
    public static void registerCommand(RegisterCommandsEvent registercommandsevent) {
        registercommandsevent.getDispatcher().register((LiteralArgumentBuilder) Commands.literal("mount").executes((commandcontext) -> {
            ...
            MountUseProcedure.execute((Entity) object);
            return 0;
        }));
    }
}
