...
import com.pla.annoyingvillagers.procedures.FriendlyFireUseProcedure;
...
public class FriendlyFireCommand {
    ...
    public static void registerCommand(RegisterCommandsEvent registercommandsevent) {
        registercommandsevent.getDispatcher().register((LiteralArgumentBuilder) Commands.literal("f-fire").then(Commands.argument("name", EntityArgument.player()).executes((commandcontext) -> {
            ...
            FriendlyFireUseProcedure.execute(serverlevel, commandcontext, (Entity) object);
            return 0;
        })));
    }
}
