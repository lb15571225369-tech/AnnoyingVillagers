...
import com.pla.annoyingvillagers.procedures.AtForUsedProcedure;

@EventBusSubscriber
public class AtForCommand {

    @SubscribeEvent
    public static void registerCommand(RegisterCommandsEvent registercommandsevent) {
        registercommandsevent.getDispatcher().register((LiteralArgumentBuilder) Commands.literal("at-for").then(Commands.argument("player", EntityArgument.player()).executes((commandcontext) -> {
            ...
            AtForUsedProcedure.execute(serverlevel, commandcontext, (Entity) object);
            return 0;
        })));
    }
}
