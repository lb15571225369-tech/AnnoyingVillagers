...
import com.pla.annoyingvillagers.procedures.GivePlayerItemProcedure;

@EventBusSubscriber
public class GivePlayerCommand {

    @SubscribeEvent
    public static void registerCommand(RegisterCommandsEvent registercommandsevent) {
        registercommandsevent.getDispatcher().register((LiteralArgumentBuilder) Commands.literal("give-player").then(Commands.argument("players", EntityArgument.player()).executes((commandcontext) -> {
            ...
            GivePlayerItemProcedure.execute(serverlevel, commandcontext, (Entity) object);
            return 0;
        })));
    }
}
