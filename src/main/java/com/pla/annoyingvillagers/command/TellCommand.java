...
//import com.pla.annoyingvillagers.procedures.TellSendProcedure;
//
//@EventBusSubscriber
...
//        registercommandsevent.getDispatcher().register((LiteralArgumentBuilder) ((LiteralArgumentBuilder) Commands.literal("tell-q").requires((commandsourcestack) -> {
//            return commandsourcestack.hasPermission(1);
//        })).then(Commands.argument("player", EntityArgument.player()).then(Commands.argument("message", StringArgumentType.string()).executes((commandcontext) -> {
...
//
//            TellSendProcedure.execute(commandcontext, (Entity) object);
//            return 0;
//        }))));
//    }
//}
