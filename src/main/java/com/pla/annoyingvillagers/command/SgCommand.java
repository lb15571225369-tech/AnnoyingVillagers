...
//import com.pla.annoyingvillagers.procedures.SGCommeProcedure;
//
//@EventBusSubscriber
...
//        registercommandsevent.getDispatcher().register((LiteralArgumentBuilder) ((LiteralArgumentBuilder) Commands.literal("s_g").requires((commandsourcestack) -> {
...
//
//            SGCommeProcedure.execute((Entity) object);
//            return 0;
//        }));
//    }
//}
