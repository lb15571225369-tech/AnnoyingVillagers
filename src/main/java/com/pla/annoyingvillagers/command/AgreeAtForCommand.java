...
import com.pla.annoyingvillagers.procedures.AgreeAtForUsedProcedure;

@EventBusSubscriber
public class AgreeAtForCommand {

    @SubscribeEvent
    public static void registerCommand(RegisterCommandsEvent registercommandsevent) {
        registercommandsevent.getDispatcher().register((LiteralArgumentBuilder) Commands.literal("agree-at-for").then(Commands.argument("player", EntityArgument.player()).executes((commandcontext) -> {
            ...
            AgreeAtForUsedProcedure.execute(serverlevel, commandcontext, (Entity) object);
            return 0;
        })));
    }
}
