...
//import com.pla.annoyingvillagers.procedures.FFireOffUseProcedure;
//
//@EventBusSubscriber
//public class FFireOffCommand {
//
//    @SubscribeEvent
//    public static void registerCommand(RegisterCommandsEvent registercommandsevent) {
//        registercommandsevent.getDispatcher().register((LiteralArgumentBuilder) Commands.literal("f-fire-off").then(Commands.argument("name", EntityArgument.player()).executes((commandcontext) -> {
...
//
//            FFireOffUseProcedure.execute(commandcontext, (Entity) object);
//            return 0;
//        })));
//    }
//}
